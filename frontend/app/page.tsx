      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="mx-auto flex max-w-5xl flex-col items-center px-6 pt-20 text-center">
          ...
          <p className="mt-4 max-w-2xl text-base text-muted-foreground">
            A friendly form builder that feels like writing. Share a link,
            collect responses, and keep everything simple.
          </p>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <a
              ...
              className="fixed bottom-6 right-6 flex items-center justify-center w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-all hover:scale-110"
